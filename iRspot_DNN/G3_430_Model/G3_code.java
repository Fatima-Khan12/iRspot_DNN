...
public class prac {
    ...
    public static void main(String[] args) throws Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("Z5_L425.txt").getFile()));

        //Second: the RecordReaderDataSetIterator handles conversion to DataSet objects, ready for use in neural network
        int labelIndex = 430;     //5 values in each row of the iris.txt CSV: 4 input features followed by an integer label (class) index. Labels are the 5th value (index 4) in each row
...
*/
                ...
                MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .list()
                    .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(413).build())       // Dropout: 40%
                    .layer(1, new DenseLayer.Builder().nIn(413).nOut(318).build())
                    .layer(2, new DenseLayer.Builder().nIn(318).nOut(251).build())
                    .layer(3, new DenseLayer.Builder().nIn(251).nOut(182).build())
                    .layer(4, new DenseLayer.Builder().nIn(182).nOut(96).build())
                    .layer(5, new OutputLayer.Builder().nIn(96).nOut(outputNum)
