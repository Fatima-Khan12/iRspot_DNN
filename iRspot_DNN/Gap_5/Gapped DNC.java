...
public class prac {
    ...
    public static void main(String[] args) throws Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("Gap_5.txt").getFile()));
...
*/
                ...
                MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .list()
                    .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(4).build())       // Dropout: 40%
                    .layer(1, new DenseLayer.Builder().nIn(4).nOut(3).build())
                    .layer(2, new OutputLayer.Builder().nIn(3).nOut(outputNum)
