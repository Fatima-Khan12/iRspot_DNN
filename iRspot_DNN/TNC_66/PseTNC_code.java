...
public class prac {
    ...
    private static Logger log = LoggerFactory.getLogger(prac.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("TNC_66.txt").getFile()));

        //Second: the RecordReaderDataSetIterator handles conversion to DataSet objects, ready for use in neural network
        int labelIndex = 66;     //5 values in each row of the iris.txt CSV: 4 input features followed by an integer label (class) index. Labels are the 5th value (index 4) in each row
...
*/
                ...
                MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .list()
                    .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(50).build())       // Dropout: 40%
                    .layer(1, new DenseLayer.Builder().nIn(50).nOut(30).build())
                    .layer(2, new DenseLayer.Builder().nIn(30).nOut(15).build())
                    .layer(3, new OutputLayer.Builder().nIn(15).nOut(outputNum)
