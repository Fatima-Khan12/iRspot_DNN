...
public class prac {
    ...
    public static void main(String[] args) throws Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("G9_257.txt").getFile()));

        //Second: the RecordReaderDataSetIterator handles conversion to DataSet objects, ready for use in neural network
        int labelIndex = 257;     //5 values in each row of the iris.txt CSV: 4 input features followed by an integer label (class) index. Labels are the 5th value (index 4) in each row
...
*/
                ...
                MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .list()
                    .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(220).build())       // Dropout: 40%
                    .layer(1, new DenseLayer.Builder().nIn(220).nOut(190).build())
                    .layer(2, new DenseLayer.Builder().nIn(190).nOut(160).build())
                    .layer(3, new DenseLayer.Builder().nIn(160).nOut(120).build())
                    .layer(4, new DenseLayer.Builder().nIn(120).nOut(70).build())
                    .layer(5, new OutputLayer.Builder().nIn(70).nOut(outputNum)
