...
public class prac {
    ...
    public static void main(String[] args) throws Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("Rev_12.txt").getFile()));
...
*/
                ...
                MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .list()
                    .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(10).build())       // Dropout: 40%
                    .layer(1, new DenseLayer.Builder().nIn(10).nOut(5).build())
                    .layer(2, new OutputLayer.Builder().nIn(5).nOut(outputNum)
